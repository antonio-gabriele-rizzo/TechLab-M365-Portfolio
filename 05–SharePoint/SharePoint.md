...
![SharePoint Start Page](screenshots/sharepoint-start-page.png)
...
![Create Team Site](screenshots/create-team-site.png)
...
![Add Site Members](screenshots/add-site-members.png)

![Team Site Created](screenshots/team-site-created.png)
...
![Document Uploaded](screenshots/document-uploaded.png)
...
![Site Permissions](screenshots/site-permissions.png)
...
2. Use the Recent Sites section.
3. Access the site directly through its URL when necessary.
4. Verify site availability through Site Information.

---

## Lessons Learned

- SharePoint sites may not immediately appear in Recent Sites.
- The SharePoint Admin Center can be unavailable while SharePoint Online remains operational.
- Blocked Sign-In status can prevent users from being added to SharePoint resources.
- Team Sites and Communication Sites serve different business purposes.
- Word Online automatically saves changes and creates SharePoint versions.
